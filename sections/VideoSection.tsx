...
// Video data (unlimited items; { id, title, thumbnail, src })
// 
// To add a new video:
// 1. Place video file in: public/assets/videos/[filename].mp4
// 2. Place thumbnail in: public/assets/images/videos/[filename]-cover.jpg
// 3. Add entry below with correct paths:
//    - src: '/assets/videos/[filename].mp4'
//    - thumbnail: '/assets/images/videos/[filename]-cover.jpg'
const videos = [
  {
    id: 1,
    title: 'Architectural Walkthrough',
    description: 'Immersive 3D walkthrough of our latest commercial project',
    src: '/assets/videos/architectural-walkthrough.mp4',
    thumbnail: '/assets/images/videos/architectural-walkthrough-cover.jpg',
    duration: '2:45'
  },
  {
    id: 2,
    title: 'Construction Progress',
    description: 'Timelapse of construction phases from foundation to completion',
    src: '/assets/videos/construction-progress.mp4',
    thumbnail: '/assets/images/videos/construction-progress-cover.jpg',
    duration: '3:20'
  },
  {
    id: 3,
    title: 'Interior Design Showcase',
    description: 'Detailed interior design concepts and material selections',
    src: '/assets/videos/interior-design-showcase.mp4',
    thumbnail: '/assets/images/videos/interior-design-showcase-cover.jpg',
    duration: '4:15'
  },
  {
    id: 4,
    title: 'Sustainable Features',
    description: 'Green building technologies and sustainable design elements',
    src: '/assets/videos/sustainable-features.mp4',
    thumbnail: '/assets/images/videos/sustainable-features-cover.jpg',
    duration: '2:30'
  },
  {
    id: 5,
    title: '3D Architecture Demo',
    description: 'Advanced 3D architectural visualization and modeling',
    src: '/assets/videos/3d-architecture-demo.mp4',
    thumbnail: '/assets/images/videos/architectural-walkthrough-cover.jpg', // Using existing thumbnail as placeholder
    duration: '4:30'
  },
  {
    id: 6,
    ...
    description: 'Advanced 3D architectural visualization and modeling',
    src: '/assets/videos/3d-architecture.mp4',
    thumbnail: '/assets/images/videos/3d-architecture-cover.jpg',
    duration: '4:30'
  }
]
    ...
    <section className="py-20 px-4">
      ...
      >
        <h2 className="text-6xl md:text-6xl font-bold text-center mb-16">
          <span className="text-primary-400">ᗩᖇᑕᕼI-</span>Video Gallery
        </h2>
