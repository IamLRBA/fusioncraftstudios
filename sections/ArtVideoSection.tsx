...
// Art Video data (unlimited items; { id, title, thumbnail, src })
// 
// To add a new art video:
// 1. Place video file in: public/assets/videos/art/[filename].mp4
// 2. Place thumbnail in: public/assets/images/videos/art/[filename]-cover.jpg
// 3. Add entry below with correct paths:
//    - src: '/assets/videos/art/[filename].mp4'
//    - thumbnail: '/assets/images/videos/art/[filename]-cover.jpg'
const artVideos = [
  {
    id: 1,
    title: 'Digital Painting Tutorial - "Makima"',
    description: 'Step-by-step digital painting process using Procreate',
    src: '/assets/videos/art/digital-painting.mp4',
    thumbnail: '/assets/images/videos/art/digital-painting-cover.jpg',
    duration: '8:45'
  },
  {
    id: 2,
    title: 'Watercolor Techniques - "Floral Composition"',
    description: 'Mastering watercolor washes and layering techniques',
    src: '/assets/videos/art/watercolor-floral.mp4',
    thumbnail: '/assets/images/videos/art/watercolor-floral-cover.jpg',
    duration: '12:20'
  },
  {
    id: 3,
    title: '3D Modeling - "Character Design"',
    description: 'Creating 3D characters from concept to final render',
    src: '/assets/videos/art/3d-modeling-character.mp4',
    thumbnail: '/assets/images/videos/art/3d-modeling-character-cover.jpg',
    duration: '15:30'
  },
  {
    id: 4,
    title: 'Photography Tips - "Portrait Lighting"',
    description: 'Professional portrait photography lighting setup',
    src: '/assets/videos/art/photography-portrait.mp4',
    thumbnail: '/assets/images/videos/art/photography-portrait-cover.jpg',
    duration: '6:15'
  },
  {
    id: 5,
    title: 'Sculpture Process - "Clay Modeling"',
    description: 'Traditional clay sculpture techniques and tools',
    src: '/assets/videos/art/sculpture-clay.mp4',
    thumbnail: '/assets/images/videos/art/sculpture-clay-cover.jpg',
    duration: '18:45'
  }
]

export default function ArtVideoSection() {
  const [selectedVideo, setSelectedVideo] = useState(artVideos[0])
  ...
  const handleVideoSelect = (video: typeof artVideos[0]) => {
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  >
                   ...
                   <button
                     onClick={() => {
                       const currentIndex = artVideos.findIndex(video => video.id === selectedVideo.id)
                       const prevIndex = (currentIndex - 1 + artVideos.length) % artVideos.length
                       handleVideoSelect(artVideos[prevIndex])
                     }}
                   ...
                   >
                     <SkipBack size={20} />
                      ...
                      onClick={() => {
                        const currentIndex = artVideos.findIndex(video => video.id === selectedVideo.id)
                        const nextIndex = (currentIndex + 1) % artVideos.length
                        handleVideoSelect(artVideos[nextIndex])
                      }}
                      className="text-white/70 hover:text-white transition-colors duration-300"
                    >
                      <SkipForward size={20} />
