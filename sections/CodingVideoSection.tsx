...
// Coding Video data (unlimited items; { id, title, thumbnail, src })
// 
// To add a new coding video:
// 1. Place video file in: public/assets/videos/coding/[filename].mp4
// 2. Place thumbnail in: public/assets/images/videos/coding/[filename]-cover.jpg
// 3. Add entry below with correct paths:
//    - src: '/assets/videos/coding/[filename].mp4'
//    - thumbnail: '/assets/images/videos/coding/[filename]-cover.jpg'
const codingVideos = [
  {
    id: 1,
    title: 'React Hooks Tutorial - "useState & useEffect"',
    description: 'Complete guide to React hooks with practical examples',
    src: '/assets/videos/coding/react-hooks-tutorial.mp4',
    thumbnail: '/assets/images/videos/coding/react-hooks-tutorial-cover.jpg',
    duration: '2:57'
  },
  {
    id: 2,
    title: 'Node.js Backend Development - "API Creation"',
    description: 'Building RESTful APIs with Express.js and MongoDB',
    src: '/assets/videos/coding/nodejs-api-tutorial.mp4',
    thumbnail: '/assets/images/videos/coding/nodejs-api-tutorial-cover.jpg',
    duration: '2:16'
  },
  {
    id: 3,
    title: 'Python Data Science - "Pandas & Matplotlib"',
    description: 'Data analysis and visualization with Python libraries',
    src: '/assets/videos/coding/python-data-science.mp4',
    thumbnail: '/assets/images/videos/coding/python-data-science-cover.jpg',
    duration: '3:36'
  },
  {
    id: 4,
    title: 'Web Development - "Responsive Design"',
    description: 'Creating mobile-first responsive websites with CSS Grid',
    src: '/assets/videos/coding/responsive-design-tutorial.mp4',
    thumbnail: '/assets/images/videos/coding/responsive-design-tutorial-cover.jpg',
    duration: '2:48'
  },
  {
    id: 5,
    title: 'Coding Session - "Live Problem Solving"',
    description: 'Real-time coding session solving algorithmic challenges',
    src: '/assets/videos/coding/live-coding-session.mp4',
    thumbnail: '/assets/images/videos/coding/live-coding-session-cover.jpg',
    duration: '5:27'
  }
]

export default function CodingVideoSection() {
  const [selectedVideo, setSelectedVideo] = useState(codingVideos[0])
  ...
  useEffect(() => {
    ...
    // Preload all videos
    codingVideos.forEach(video => {
      preloadVideo(video.src)
    })
  }, [])

  const handleVideoSelect = (video: typeof codingVideos[0]) => {
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  >
                   ...
                   <button
                     onClick={() => {
                       const currentIndex = codingVideos.findIndex(video => video.id === selectedVideo.id)
                       const prevIndex = (currentIndex - 1 + codingVideos.length) % codingVideos.length
                       handleVideoSelect(codingVideos[prevIndex])
                     }}
                   ...
                   >
                     <SkipBack size={20} />
                      ...
                      onClick={() => {
                        const currentIndex = codingVideos.findIndex(video => video.id === selectedVideo.id)
                        const nextIndex = (currentIndex + 1) % codingVideos.length
                        handleVideoSelect(codingVideos[nextIndex])
                      }}
                      className="text-white/70 hover:text-white transition-colors duration-300"
                    >
                      <SkipForward size={20} />
